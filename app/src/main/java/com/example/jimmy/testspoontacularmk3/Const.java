...
//3 Create this class to hold constants, like BASE_URL (resolve the first red)
public class Const {

    public static final String BASE_URL = "https://spoonacular-recipe-food-nutrition-v1.p.mashape.com/";
    public static final String MASHAPE_KEY = "XNjiavhYormshoCzWaSZEROy21V3p103vLUjsnDrUnteqPoItz";
